...
$address = "contact@lerecifhotel.com";
...
$e_subject = 'Lerecif Inquiry from ' . $name . '.';
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you, your message has been submitted to us. <strong>$name</strong>, We shall get back to you within 24hrs.</p>";
	echo '</div>';
